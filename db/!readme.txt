...
1. Предварительно нужно указать в файле _define.sql параметры подключения
 ...
 1.7 В строке 
          define inc_subpart_row_count=3000000
     после равно нужно количество записей в инциденте на субпартицию на день.

 1.8 В строке 
          define base_day="2015-01-01"                                                               
     после равно нужно базовую дату в формате YYYY-MM-DD
...
!run_step_3.cmd                      - Скрипт запуска шага 3.
...
step_2-reorder.sql                   - скрипт выполняет распределение данных по субпартициям с учетом заданного количества
                                       Запускается один раз путем вызова командного файла !run_step_2.cmd


step_3-final.sql                     - скрипт выполняет заключительные работы. Перестройку индексов, включение констрентов.
                                       Запускается один раз путем вызова командного файла !run_step_3.cmd
